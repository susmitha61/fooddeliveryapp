...
import {
  ...
  FolderPlus, Upload, Store, Layers
} from 'lucide-react';
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="sm:col-span-2">
          ...
          <input className={inputCls} value={form.name} onChange={e => set('name', e.target.value)}
            placeholder="e.g. Paneer 65" required minLength={2} maxLength={200} />
        </div>
        <div>
...
export default function OwnerMenuPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Restaurant Menu Governance"
        description="Manage categories, add & edit food dishes, and toggle live item availability."
        actions={
